...
import { createAuthorizationRequest } from '../services/consumerstat';
...
export default function SendAuthorizationModal({ contact, onClose, onSent, onTestLink }: SendAuthorizationModalProps) {
  ...
  async function handleSend() {
    ...
    try {
      ...
      alert('Erreur lors de la création de la demande d\'autorisation');
    } finally {
      setLoading(false);
    }
  }
          ...
          {!sent ? (
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <p className="text-sm text-gray-700">
                  Un email sera envoyé automatiquement avec un lien sécurisé permettant au destinataire de compléter le formulaire d'autorisation de communication des données.
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-4">
                {onTestLink && (
                  <button
                    onClick={() => onTestLink(authorizationToken)}
